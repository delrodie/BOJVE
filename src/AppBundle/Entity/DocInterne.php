 ...
 * Image
 *
 * @ORM\Table(name="document_interne")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\docinterneRepository")
    ...
    public function getId()
    {
        ...
        */
        ...
        protected function getUploadRootDir()
        {
            ...
            //$racine = sudo chmod ;
            return __DIR__.'/../../../web/publications/'.$this->getUploadDir();
        }
